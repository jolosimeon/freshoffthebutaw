...
public class FishSwim : MonoBehaviour {
	...
	public float MoveRange = 0.4f; //change this to increase/decrease the distance between the highest and lowest points of the bounce
	public float MoveSpeed = 1.7f; //change this to make it faster or slower

	private FishSwim bounceObject; //for caching this transform
